...
export default function WorkCard({
  ...
  return (
    <div className="rounded-lg overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] card-shadow">
      <a href={contentURL} target="_blank" rel="noopener noreferrer" className="block">
        {image && (
          <div className="relative aspect-video overflow-hidden">
            ...
            />
            <div className="overlay-fade-bottom-shallow" />
          </div>
        )}
